...
module Sureties
  class Surety < ApplicationRecord
    ...
    belongs_to :project, inverse_of: :sureties, class_name: 'Core::Project'
    ...
    has_many :scans, class_name: "::Sureties::SuretyScan", dependent: :destroy
    ...
    mount_uploader :document, Core::SuretyDocumentUploader
    ...
    def prepare_for_approvement
      ...
      ::Sureties::MailerWorker.perform_async(:surety_confirmed, id)
    end

    def activate_project_accounts
      ::Sureties::MailerWorker.perform_async(:surety_accepted, id)
