module Sureties
  class SuretiesController < Core::ApplicationController
    before_action :require_login, :filter_blocked_users
    ...
    def create
      ...
      if @surety.save
        ...
        redirect_to core.project_path(@project)
      else
        redirect_to core.project_path(@project), alert: @surety.errors.full_messages.to_sentence
      end
    end
